...
const Analysis = () => {
  ...
  if (questionsBackend.length === 0) {
    return (
      <div className="min-h-screen flex flex-col items-center justify-center bg-gray-200 p-4">
        <div className="bg-white text-black rounded-lg shadow-2xl p-6 md:p-8 w-fit max-w-md md:max-w-4xl text-center">
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center bg-gray-200 p-4">
      <div className="bg-white text-black rounded-lg shadow-2xl p-6 md:p-8 w-full max-w-md md:max-w-4xl">
        ...
        <div className="space-y-6">
          {questionsBackend.map((question, index) => (
            <div
              key={index}
              className="p-4 md:p-6 bg-gray-100 rounded-lg shadow-sm"
            >
              ...
              <ul className="space-y-2 md:space-y-3">
                {question.options.map((option, optionIndex) => {
                  ...
                  const optionClasses = `
                    ...
                    ${isCorrect ? "bg-green-200 text-green-800 font-bold" : ""}
                    ${
              ...
              {question.solution && (
                <p className="mt-4 text-lg text-gray-600 flex gap-2 items-center">

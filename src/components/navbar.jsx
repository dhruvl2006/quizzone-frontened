...
const Navbar = () => {
  ...
  return (
    <div className="sticky top-0 w-full bg-white shadow-md border-b border-gray-200 z-50">
      <nav className="flex flex-col min-[950px]:flex-row w-full max-w-screen-xl mx-auto px-6 py-4 items-center justify-between">
        <div className="flex items-center justify-between w-full min-[950px]:w-auto mb-4 min-[950px]:mb-0">
          ...
          <button
            className="min-[950px]:hidden flex items-center text-gray-800"
            onClick={toggleMenu}
          >
            <img
              className="w-6 h-6"
        ...
        <div
          ...
          } overflow-hidden transition-all duration-300 ease-in-out min-[350px]:overflow-visible min-[950px]:max-h-none min-[950px]:opacity-100 w-full min-[950px]:w-auto`}
        >
          <ul className="flex flex-col items-center min-[950px]:flex-row gap-6 text-gray-800 text-lg font-medium">
            <li>
              <NavLink
            ...
            <li>
              <div className="min-[950px]:flex text-gray-800 flex items-center gap-3 sm:pt-0 pt-5">
